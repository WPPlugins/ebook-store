...
<?php do_settings_sections( 'ebook-settings-group-general' ); ?>
        ...
        <br />
        <?php echo __('If you own the PRO version you can also enable Ebook Store to work with WooCommerce via the <a href="options-general.php?page=ebook_options.php&tab=Integrations">Integrations</a> page. See <a target="_blank" href="https://www.youtube.com/watch?v=dJTvA0-lGmI">video demo</a>. <br />', 'ebook-store'); ?>
        </td>
        </tr>
        ...
        <td><input type="checkbox" name="email_delivery"  value="1" <?php echo (get_option('email_delivery') != 0 ? 'checked="checked"' : ''); ?> />
        ...
        <td><input type="text" name="vat_percent" value="<?php echo get_option('vat_percent'); ?>" placeholder="20" />
