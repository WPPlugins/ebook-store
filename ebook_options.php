...
<?php if (get_option('ebook_store_license_key') == '') {?>
 FREE (<a href="#"><?php echo __('Upgrade to Pro', 'ebook-store'); ?></a>)
<?php } ?>
</h2>
<?php
...
<?php foreach ($tabs as $tab_key => $tab_value) { ?>
    <a href="options-general.php?page=ebook_options.php&tab=<?php echo $tab_key; ?>" class="nav-tab<?php echo ($tab == $tab_key ? ' nav-tab-active' : ''); ?>"><?php echo $tab_value; ?></a>
<?php } ?>
</nav>
